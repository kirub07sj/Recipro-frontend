    ...
    return (
        <div className="min-h-screen flex bg-[#080d0a] text-white font-sans relative overflow-hidden before:content-[''] before:absolute before:-top-[10%] before:-left-[10%] before:w-[50%] before:h-[60%] before:bg-[radial-gradient(circle,rgba(0,255,132,0.05)_0%,rgba(0,0,0,0)_70%)] before:rounded-full before:pointer-events-none before:z-0 after:content-[''] after:absolute after:-bottom-[20%] after:-right-[10%] after:w-[60%] after:h-[60%] after:bg-[radial-gradient(circle,rgba(0,255,132,0.03)_0%,rgba(0,0,0,0)_70%)] after:rounded-full after:pointer-events-none after:z-0">
            <div className="w-full flex justify-center items-center py-10 px-5 z-10">
                <div className="w-full max-w-[1000px] bg-[#0b110d] border border-white/5 rounded-[32px] flex flex-col md:flex-row shadow-[0_40px_80px_rgba(0,0,0,0.5)] overflow-hidden md:min-h-[700px]">
                    ...
                    <div className="flex-1 bg-[#111a14] py-[60px] px-12 flex flex-col justify-between relative border-r border-white/5">
                        ...
                        <div className="relative z-10 my-[60px] mb-10">
                            <h2 className="text-[40px] font-extrabold leading-[1.1] m-0 mb-5 bg-[linear-gradient(180deg,#ffffff_0%,#8b9a91_100%)] text-transparent bg-clip-text">Join the<br />Culinary Revolution.</h2>
                    ...
                    <div className="flex-1 py-[60px] px-12 flex flex-col justify-center max-w-full md:max-w-[480px]">
                        ...
                        <form className="flex flex-col gap-4" onSubmit={onFinish}>
                            <div className="flex gap-4">
                                <div className="flex flex-col gap-2 flex-1 relative group-focus-within:text-[#00ff84]">
                                    <label className="text-[13px] font-semibold text-[#e2e8f0] ml-1">First Name</label>
                                    <div className="relative flex items-center">
                                        <svg className="absolute left-4 text-[#4a5c53] pointer-events-none transition-colors peer-focus:text-[#00ff84] peer-[:not(:placeholder-shown)]:text-[#00ff84]" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></svg>
                                        <input
                                            type="text"
                            ...
                            <div className="my-2">
                                <label className="flex items-start gap-2 cursor-pointer text-[13px] text-[#8b9a91] leading-[1.4]">
                                    <input type="checkbox" required className="mt-0.5 w-4 h-4 accent-[#00ff84] cursor-pointer" />
                        ...
                        <div className="flex items-center my-6 text-[#4a5c53] text-xs font-semibold uppercase tracking-widest before:content-[''] before:flex-1 before:h-[1px] before:bg-white/5 before:mr-4 after:content-[''] after:flex-1 after:h-[1px] after:bg-white/5 after:ml-4">Or sign up with</div>
                        ...
                        <div className="text-center mt-8 text-sm text-[#8b9a91]">
                            ...
                            <button type="button" onClick={() => navigate("/login")} className="bg-transparent border-none text-[#00ff84] font-semibold ml-1.5 cursor-pointer p-0 hover:underline">Sign in</button>
                        </div>
                    </div>
                </div>
            </div>
