        ...
        <div className="min-h-screen flex bg-[#080d0a] text-white font-sans relative overflow-hidden">
            ...
            <div className="w-full flex justify-center items-center py-10 px-5 relative z-10">
                <div className="w-full max-w-[1000px] bg-[#0b110d] border border-white/5 rounded-[32px] flex flex-col md:flex-row overflow-hidden shadow-[0_40px_80px_rgba(0,0,0,0.5)] md:min-h-[600px]">
                    ...
                    {/* Left Hero Section */}
                    <div className="flex-1 bg-[#111a14] px-12 py-[60px] flex flex-col justify-between relative border-b md:border-b-0 md:border-r border-white/25">
                        ...
                        <div className="relative z-10 mt-[60px] mb-10">
                            <h2 className="text-[40px] font-extrabold leading-[1.1] m-0 mb-5 bg-[linear-gradient(180deg,#ffffff_0%,#8b9a91_100%)] bg-clip-text text-transparent [-webkit-text-fill-color:transparent]">Your personal<br />AI sous-chef.</h2>
                    ...
                    <div className="flex-1 px-12 py-[60px] flex flex-col justify-center max-w-full md:max-w-[480px]">
                        ...
                        <form className="flex flex-col gap-5" onSubmit={onFinish}>
                            ...
                            <div className="flex justify-between items-center -mt-1">
                                ...
                                <button type="button" className="text-[#00ff84] no-underline text-[13px] font-semibold transition-opacity duration-200 bg-transparent border-none cursor-pointer p-0 hover:opacity-80" onClick={() => navigate('/forgot-password')}>Forgot Password?</button>
                            </div>
                        ...
                        <div className="flex items-center my-8 text-[#4a5c53] text-xs font-semibold uppercase tracking-[0.1em] before:content-[''] before:flex-1 before:h-px before:bg-white/5 before:mr-4 after:content-[''] after:flex-1 after:h-px after:bg-white/5 after:ml-4">Or continue with</div>
                        ...
                        <div className="text-center mt-8 text-sm text-[#8b9a91]">
                            ...
                            <button type="button" className="bg-transparent border-none text-[#00ff84] font-semibold ml-1.5 cursor-pointer p-0 hover:underline" onClick={() => navigate("/register")}>Sign up</button>
                        </div>
                    </div>
                </div>
            </div>
