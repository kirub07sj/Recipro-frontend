                ...
                <div className="login-card">
                    ...
                    <div className="login-hero">
                        ...
                        <div className="hero-text">
                            <h2>Your personal<br />AI sous-chef.</h2>
                            <p>Sign in to access your personalized meal plans, track nutrition, and generate recipes from whatever is in your fridge.</p>
                        </div>
