            ...
            <aside className="sidebar">
                ...
                <div className="bottom-actions">
                    ...
                    <div className="profile-card">
                        <img src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" alt="Alex Doe" className="profile-avatar" />
                        <div className="profile-info">
                            <h4 className="profile-name">Alex Doe</h4>
                            <p className="profile-score">HEALTH SCORE: 85</p>
                        </div>
                    </div>
                </div>
            </aside>
            ...
            <main className="main-content">
                <header className="header">
                    <div>
                        ...
                        <h1 className="page-title">Ready to cook, Alex?</h1>
                ...
                <div className="dashboard-grid">
                    ...
                    <div className="hero-card">
                        ...
                        <button className="snap-btn">
                            ...
                            <span>
                                Snap Ingredients
                                <span className="subtitle">Use camera to scan food</span>
                            </span>
                        </button>
                    </div>
                        ...
                        <div className="action-card">
                            <div className="action-info">
                                ...
                                <div className="action-text">
                                    <h3>Upload Photo</h3>
                                    <p>Analyze gallery items</p>
                                </div>
                            </div>
                            <svg className="arrow-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6" /></svg>
                        </div>
