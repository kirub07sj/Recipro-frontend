...
const CookingGuide = () => {
  ...
  const dashOffset = 377 * (1 - timerProgress);
  ...
  return (
    <div className="min-h-screen w-full bg-[#05160b] text-white font-sans selection:bg-[#15803d] selection:text-white flex flex-col items-center justify-start overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl px-4 py-8 md:px-6 md:py-12 flex flex-col h-full" style={{ opacity: 1 }}>
        {/* Header - Progress */}
        <div className="mb-6 md:mb-12">
          <div className="flex justify-between items-end mb-4">
            <div>
              ...
              <div className="h-1 w-48 md:w-64 bg-white/10 rounded-full overflow-hidden">
        ...
        {/* Main Content */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center flex-grow">
          <div className="space-y-4 md:space-y-6" style={{ opacity: 1, transform: 'none' }}>
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight leading-tight">{stepData.title}</h1>
            ...
            {stepData.tip && (
              <div className="p-4 bg-[#15803d]/10 border-l-4 border-[#15803d] rounded-r-xl">
                <p className="text-xs md:text-sm italic text-[#4ade80]">
          ...
          {stepData.timeSeconds > 0 ? (
            <div className="flex flex-col items-center justify-center">
              <div className="relative w-48 h-48 flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <div className="text-4xl font-mono font-bold tracking-widest leading-none drop-shadow-md">{formatTime(timeLeft)}</div>
                  <div className="text-[10px] text-white/40 uppercase tracking-[0.3em] mt-2 font-semibold">{timeLeft === 0 ? "Done" : "Remaining"}</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 mt-8 relative z-20">
                ...
                <button
                  onClick={toggleTimer}
                  disabled={timeLeft === 0}
                  className={`group relative flex items-center justify-center w-14 h-14 rounded-full transition-all active:scale-95 shadow-lg ${timeLeft === 0 ? 'bg-zinc-700 text-zinc-500 cursor-not-allowed' : 'bg-[#4ade80] hover:bg-[#22c55e] text-[#05160b]'}`}
                >
                  {isRunning ? (
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-1"><path d="M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"></path></svg>
                  )}
                </button>
            ...
            <div className="flex flex-col items-center justify-center h-full">
              <div className="w-48 h-48 flex flex-col items-center justify-center bg-white/5 rounded-full border-4 border-white/5">
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#4ade80] mb-4"><path d="M12 2v20"></path><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
        ...
        {/* Footer Navigation */}
        <div className="mt-auto pt-8 md:pt-16 flex items-center justify-between">
          <button
            onClick={handleBack}
          ...
          <button
            onClick={handleNext}
            className="group flex items-center gap-3 px-8 md:px-10 py-4 bg-[#4ade80] text-[#05160b] rounded-2xl font-bold transition-all hover:bg-[#22c55e] active:scale-95 shadow-xl shadow-[#4ade80]/10 text-sm md:text-base"
          >
